...
3. **Preferencias** — orden de 5 prioridades, tolerancia a huecos, hora mínima, días bloqueados y rango mínimo/máximo de créditos (0–30). Si el máximo supera 21, se avisa que el sobrecupo depende del promedio y debe verificarse con CESA.
...
- **Reglas duras** (descartan): cruces, hora mínima, días bloqueados, grupos fijados, rango de créditos elegido por el estudiante y selección declarada.
- **Preferencias suaves**: profesores, huecos, madrugar, días libres, terminar temprano. La primera prioridad se compara antes que las demás; las restantes deciden entre horarios equivalentes en la primera.
- **Huecos**: solo cuentan los intervalos entre clases de un mismo día. Entrar tarde no agrega huecos y el almuerzo de 12:00 a 2:00 no cuenta.
