...
const PENSUM = [
  ...
  ['ma2','Matemáticas Aplicadas 2',3,2,['ma1']],['co','Comunicación Oral',3,2,['ce']],['mi','Microeconomía',3,2,['ie']],['pa','Pensamiento Administrativo',2,2,[]],['ac','Administración de Costos',2,2,['cb']],['tic','TIC Aplicadas a la Toma de Decisiones',2,2,[]],['dn','Derecho de Negocios',2,2,['idr']],['es1','Electiva Sociohumanística 1',2,2,[]],['i1','Idiomas 1',0,2,[]],['b2','Bienestar 2',0,2,['b1']],
  ['ep','Estadística y Probabilidad',3,3,['ma2']],['mac','Macroeconomía',3,3,['mi']],['pm','Principios de Mercadeo',3,3,[]],['pce','Planeación y Control Estratégico',3,3,['fa']],['anf','Análisis Financiero',2,3,['ac']],['ci','Creatividad e Innovación',2,3,[]],['dl','Derecho Laboral',2,3,['dn']],['es2','Electiva Sociohumanística 2',2,3,[]],['i2','Idiomas 2',0,3,['i1']],['gl','Grandes Líderes',0,3,[]],['b3','Bienestar 3',0,3,['b2']],
  ['ea','Estadística Aplicada',3,4,['ep']],['hec','Historia Económica',2,4,[]],['dor','Diseño Organizacional',3,4,['pce']],['mf','Matemáticas Financieras',3,4,['cb']],['gh','Gestión Humana',3,4,[]],['dt','Derecho Tributario',2,4,['dn']],['pie','Proyecto Integrador Espíritu Emprendedor',4,4,['ci']],['i3','Idiomas 3',0,4,['i2']],['b4','Bienestar 4',0,4,['b3']],
  ...
  ['v1','Visitas 1',2,6,['adf']],['ao','Administración de Operaciones',3,6,['io']],['dc','Dirección Comercial',2,6,[]],['to','Transformación Organizacional',2,6,[]],['ni','Negocios Internacionales',2,6,['pce']],['mc','Mercado de Capitales',3,6,['adf','mf']],['gi','Gestión de Innovación',2,6,[]],['mtd','Modelos para la Toma de Decisiones',3,6,['tic','adf']],['b6','Bienestar 6',0,6,['b5']],
  ['v2','Visitas 2',3,7,['v1']],['gcs','Gerencia de la Cadena de Suministro',3,7,[]],['spv','Seminario Preparación Vida Laboral',0,7,['v1']],['md','Marketing Digital',2,7,[]],['se','Sostenibilidad Empresarial',3,7,[]],['pf','Planeación Financiera',3,7,['adf']],['epr1','Electiva Profesional 1',3,7,['mtd']],['pire','Proyecto Integrador Reto Empresarial',4,7,['gi','mtd']],
